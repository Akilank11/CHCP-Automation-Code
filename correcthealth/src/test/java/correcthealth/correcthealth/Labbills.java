...
public class Labbills {WebDriver driver = new ChromeDriver();
//WebDriver driver;
...
public void f() throws InterruptedException {
	  driver.get("http://localhost:8090/CHCP/login");
	 	...
	 	otherbill.click(); 
	 	Thread.sleep(3000);
	 	WebElement labbill = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Lab Bills']"))); 
	 	labbill.click();
  Thread.sleep(2000);
...
//Page navigation
		        WebElement pagenavigation = driver.findElement(By.name("labBillsSummaryTable_length"));
		        Select select4 = new Select(pagenavigation);
		        select4.selectByVisibleText("80");
		        Thread.sleep(3000);
		        WebElement nextpage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("labBillsSummaryTable_next")));
		        nextpage.click();
		        Thread.sleep(5000);
		        WebElement previous = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("labBillsSummaryTable_previous")));
		        previous.click();
		        Thread.sleep(8000);

...
public class VisitIDswithOutstandingClaimsReport {
...
public void f() throws InterruptedException {
	  driver.get("http://localhost:8090/CHCP/login");
	 	...
	 	WebElement specialitycarevisitireports = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='VisitIDs with Outstanding Claims Report']"))); 

...
public class Vendorcptcoderates {
	...
	public void f() throws InterruptedException {
		  driver.get("http://localhost:8090/CHCP/login");
		 	...
		 	Thread.sleep(3000);
		 	WebElement vendorcptcoderates = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Vendor CPTCode Rates']"))); 
		 	vendorcptcoderates.click();
	  Thread.sleep(2000);
...
Thread.sleep(1500);
 ...
 Thread.sleep(2000);
 WebElement checkboxclick = wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='vendorCPTCodeRatesCheck'])[1]")));
 checkboxclick.click();
 ...
 Thread.sleep(1000);
 WebElement pagenavigation = driver.findElement(By.name("vendorCPTCodeRatesTable_length"));
 Select select4 = new Select(pagenavigation);
 select4.selectByVisibleText("200");
 Thread.sleep(3000);
 WebElement nextpage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("vendorCPTCodeRatesTable_next")));
 nextpage.click();
 Thread.sleep(3000);
 WebElement previous = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("vendorCPTCodeRatesTable_previous")));
 previous.click();
 Thread.sleep(4000);

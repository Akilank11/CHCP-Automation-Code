...
public class Claimwithoutpatientidreport {WebDriver driver = new ChromeDriver();
//WebDriver driver;
...
public void f() throws InterruptedException {
	  driver.get("http://localhost:8090/CHCP/login");
	 	...
	 	otherbill.click(); 
	 	Thread.sleep(3000);
	 	WebElement xraybill = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Claims without Patients Report']"))); 
	 	xraybill.click();
Thread.sleep(2000);

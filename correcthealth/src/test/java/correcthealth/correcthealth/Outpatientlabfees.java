...
public class Outpatientlabfees {
	...
	public void f() throws InterruptedException {
		  driver.get("http://localhost:8090/CHCP/login");
		 	...
		 	Thread.sleep(3000);
		 	WebElement outpatientlabfees = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Outpatient Lab Fees']"))); 
		 	outpatientlabfees.click();
	  Thread.sleep(2000);
   ...
   driver.findElement(By.id("maxunits")).sendKeys("10");
...
Thread.sleep(1500);
 ...
 Thread.sleep(2000);
 WebElement checkboxclick = wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//tr[@id='row_14658']//input[@id='outPatientLabFeesCheck']")));
 checkboxclick.click();
 ...
 Thread.sleep(1000);
 WebElement pagenavigation = driver.findElement(By.name("outPatientLabFeesTable_length"));
 Select select4 = new Select(pagenavigation);
 select4.selectByVisibleText("200");
 Thread.sleep(3000);
 WebElement nextpage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("outPatientLabFeesTable_next")));
 nextpage.click();
 Thread.sleep(3000);
 WebElement previous = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("outPatientLabFeesTable_previous")));
 previous.click();
 Thread.sleep(4000);

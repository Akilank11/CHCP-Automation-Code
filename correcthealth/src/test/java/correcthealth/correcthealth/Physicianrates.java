...
public class Physicianrates {
	...
	public void f() throws InterruptedException {
		  driver.get("http://localhost:8090/CHCP/login");
		 	...
		 	Thread.sleep(3000);
		 	WebElement physicianrates = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Physician Rates']"))); 
		 	physicianrates.click();
	  Thread.sleep(2000);
      ...
      driver.findElement(By.id("modifier")).sendKeys("Test data");
      driver.findElement(By.id("rate")).sendKeys("33.54");
      driver.findElement(By.id("maxallow")).sendKeys("1000");
      driver.findElement(By.id("minunits")).sendKeys("10");
...
Thread.sleep(1500);
 ...
 Thread.sleep(2000);
 WebElement checkboxclick = wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//tr[@id='row_8605']//input[@id='physicianRatesCheck']")));
 checkboxclick.click();
 ...
 Thread.sleep(1000);
 WebElement pagenavigation = driver.findElement(By.name("physicianRatesTable_length"));
 Select select4 = new Select(pagenavigation);
 select4.selectByVisibleText("200");
 Thread.sleep(3000);
 WebElement nextpage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("physicianRatesTable_next")));
 nextpage.click();
 Thread.sleep(3000);
 WebElement previous = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("physicianRatesTable_previous")));
 previous.click();
 Thread.sleep(4000);
 ...
 download.click();
	...
	public void fileupload() throws InterruptedException {
	  ...
	  driver.findElement(By.xpath("//button[normalize-space()='ok']")).click();
	  Thread.sleep(1500);
	  WebElement delete = wait3.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//tr[@id='row_100']//td[contains(@class,'delete-control fileDeleteBtn2')]")));
	  delete.click();
	  Thread.sleep(500);
	  driver.findElement(By.xpath("//button[normalize-space()='confirm']")).click();
	  Thread.sleep(1000);

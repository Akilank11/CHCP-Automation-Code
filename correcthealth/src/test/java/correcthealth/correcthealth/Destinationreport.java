...
public class Destinationreport {
	...
	public void f() throws InterruptedException {
		  driver.get("http://localhost:8080/CHCP/login");
		 	...
		 	WebElement Destinationreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Destination Report']"))); 
		 	Destinationreport.click();
	        Thread.sleep(2000);
	        
	//Select Vendor Name
	WebElement Vendorname = driver.findElement(By.id("select2-autoCompleterVendorName-container"));
	Vendorname.click();  
	driver.findElement(By.xpath("//input[@role='textbox']")).sendKeys("Corona");
	Thread.sleep(1000);
  ...
  //Select From date
    ...
    FROMDATE.click();
    FROMDATE.click();
    WebElement FROMDATEselect = wait1.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("td[data-date='11'][data-month='0'][data-year='2025']")));
  ...
  //Select To date
    ...
    Todate.click();
    WebElement Todateselect = wait2.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("td[data-date='30'][data-month='3'][data-year='2025']")));
    Todateselect.click();
    Thread.sleep(2000);
